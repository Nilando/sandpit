...
use super::tracer_controller::{TracerController, TracePacket};
...
impl<A: Allocate> TracerWorker<A> {
    pub fn spawn(unscanned: Arc<Mutex<Vec<TracePacket<TracerWorker<A>>>>>, mark: <<A as Allocate>::Arena as GenerationalArena>::Mark) {
